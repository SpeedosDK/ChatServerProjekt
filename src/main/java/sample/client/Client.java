...
import sample.service.IFileTransferService;
...
public class Client {
    ...
    private final IFileTransferService fileService;

    public Client(IFileTransferService fileService) {
...
//                        }
            ...
            while (true) {
                try {
                    ...
                    System.out.println("Forkert kommando - prøv igen: Brug /TEXT, /EMOJI, /FILE_OFFER, /JOIN_ROOM, /PRIVATE : " + e.getMessage());
                }
            }
        } catch (IOException e){
    ...
    public static void main(String[] args) {
        IFileTransferService fileService = new ClientFileService();
        Client client = new Client(fileService);
        client.start();
    }
}